...
class Merger {
    #users will select files, display selected files on the browser (just an icon + the file name), 
    #add a button for removing files (NOT DONE)
    #from the selection, add an optional input for users to type in their preferred name (including ext) to save the file to be created with (NOT DONE),
    #use current timestamp if no name is provided, 
    #send files to server, merge and name file, save merged file to server for download,
